...
/*--- time options ---*/
  int time_opt;             /* 0 - grid relative 1 - dimension environment relative */ 
...
struct gafile {
  ...
  char dnam[200];            /* Descriptor file name                  */
...
/* mf increase to hold array for eta model wind rotation */

  float *ppf[3];             /* Pointers to interpolation constants
