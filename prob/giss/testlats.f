...
C
C
      include "/usr/local/lats/LATS-1.0/include/lats.inc"
C
C         define the grid:
C
...
C
     ...
     1    'tauu','tauv'/
      ...
      open(45,file='rls',form='formatted',status='old',
     $     err=820)
...
C0000000000000000000000000000000000000000000000000
      ...
      id_parmtab=latsparmtab("amip2.lats.table.23.A20")
...
cc777     continue
          ...
          read(45,9010)((vdata(i,j),i=1,ni),j=1,nj)
 9010 format(8e10.5)
cccc      write(*,9010)((vdata(i,j),i=1,ni),j=1,nj)
...
C
 ...
 820  continue
      print*,'Error 820, unable to open input text file'
      stop 820
