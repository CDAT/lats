...
CC = cc
CFLAGS = -I.  -I/usr/local/uvcdat/latest/Externals/include $(DEBUG)
...
LDFLAGS = -L. -llats -L/usr/local/uvcdat/latest/Externals/lib -lnetcdf  -lm
OS = linux
RANLIB = :
